...
var characterMapPath = './character_map.json';
var characterDir = './Characters/';
if (process.env.NODE_ENV === 'development') {
  characterMapPath = './test/character_map.json';
  characterDir = './test/Characters/';
}

export const CHARACTER_MAP_PATH = characterMapPath;    // character map
export const CHARACTER_DIR = characterDir;             // saved characters
...
// characters
//
// characterDirectory: a directory that holds
//   characters
