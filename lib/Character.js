...
export const CHARACTER_MAP_PATH = './test/character_map.json';                      // character map
export const CHARACTER_DIR = './test/Characters/';                                  // saved characters

const DB_LOCATION = './lib/db/';
...
export const RACES_DB = JSON.parse(fs.readFileSync(DB_LOCATION + 'racesDB.json'));
export const BACKGROUNDS_DB = JSON.parse(fs.readFileSync(DB_LOCATION + 'backgroundsDB.json'));
export const FEATURE_TRAITS_DB = JSON.parse(fs.readFileSync(DB_LOCATION + 'featureTraitsDB.json'));
export const CLASSES_DB = JSON.parse(fs.readFileSync(DB_LOCATION + 'classesDB.json')).classes;
...
export default class Character {
  ...
  importFromJSON(path) {
    console.log('this is why we fail')
  ...
  saveCharacter(path) {
    ...
    if (this.originalName !== this.name && fs.existsSync(path)) {
      fs.unlink(path);
    }
