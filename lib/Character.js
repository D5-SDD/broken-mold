...
export const WEAPONS_DB = JSON.parse(fs.readFileSync('./lib/db/weaponsDB.json'));   // weapons database
export const ARMOR_DB = JSON.parse(fs.readFileSync('./lib/db/armorDB.json'));       // armor database
