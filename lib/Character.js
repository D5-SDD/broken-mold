...
export default class Character {
  ...
  isCharacterValid() {
    ...
    else if (this.abilityScores.strength === undefined) {
      return false;
    }
    else if (this.abilityScores.dexterity === undefined) {
      return false;
    }
    else if (this.abilityScores.constitution === undefined) {
      return false;
    }
    else if (this.abilityScores.intelligence === undefined) {
      return false;
    }
    else if (this.abilityScores.wisdom === undefined) {
      return false;
    }
    else if (this.abilityScores.charisma === undefined) {
      return false;
    }
    return true;
  }
  ...
  createDefaultCharacter() {
    ...
    this.abilityScores.strength = undefined;
    this.abilityScores.dexterity = undefined;
    this.abilityScores.constitution = undefined;
    this.abilityScores.intelligence = undefined;
    this.abilityScores.wisdom = undefined;
    this.abilityScores.charisma = undefined;   
    this.abilityScoreMods = {
      strength:0,
      dexterity:0,
      constitution:0,
...
export function readMap() {  
  var characters = [];
  var characterMap = JSON.parse(fs.readFileSync(CHARACTER_MAP_PATH)).map;
  console.log(characterMap.length);
  for (let i = 0; i < characterMap.length; i++) {
    let path = './test/Characters/' + characterMap[i].filename;
    characters.push(new Character(path));
  }
  return characters;
}
